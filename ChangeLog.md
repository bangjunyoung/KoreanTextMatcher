...
- `KoreanChar` 타입에 새로 추가된 API:
  - 자모를 음절 조합: `compose`
  - 음절을 자모로 분해: `decompose`, `decomposeToCompat`
...
- ```[BREAKING CHANGE]```: `KoreanChar.decomposeIntoCompatJamo` 삭제.
...
- [JUnit](https://junit.org/) 버전을 6.0으로 상향.
...
- [JDK](https://developers.redhat.com/products/openjdk) 11 기반.
